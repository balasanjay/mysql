...
Possible Parameters are:
  ...
  * `loc`: Sets the location for Date and Time values. The default is `UTC`. *"Local"* sets the system's location. See [time.LoadLocation](http://golang.org/pkg/time/#LoadLocation) for details.
